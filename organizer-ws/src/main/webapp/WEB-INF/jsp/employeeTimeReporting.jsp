...
<div class="time-entry bootstrap-styles">
    ...
    <table class="table table-bordered table-striped">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <td>${time:toHhMm(timePunchEntry.weekTimeWorkedMinutes)}</td>
                <td>${time:toHhMm(timePunchEntry.payPeriodTimeWorkedMinutes)}</td>
        <c:choose>
            <c:when test="${timePunchEntry.punchedIn}">
                <td>
    ...
    <div class="timesheet-buttons">
        <a href="${timesheetLink}" target="_blank" class="btn btn-default btn-sm" title="Timesheet" role="button">Timesheet</a>
        <a href="${timesheetLink2}" target="_blank" class="btn btn-default btn-sm" title="ACA Hours" role="button">ACA
            Hours</a>
